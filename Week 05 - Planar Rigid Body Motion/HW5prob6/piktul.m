...
properties
  ...
  musecLims = [550  660  589 621 1300 ;			
               1500 1520 1430 1470 1500 ;			
               2500 2370 2324 2350  1720];
...
methods
  ...
  this.linklen = [110.6 120 120]*this.mm2in;	
  ...
  function setArm(this, alpha, time)
	...
	%
	%(
    function g = lynx6_forwardkin(alpha, totip)
    ...
    Rz = @(alpha)[cos(alpha), -sin(alpha), 0; sin(alpha), cos(alpha), 0; ...
	                                                            0, 0, 1];
