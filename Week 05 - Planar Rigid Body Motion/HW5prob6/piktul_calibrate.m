%============================ piktul_calibrate ===========================
%
%  A script used to calibrate the piktul.  Saves the calibration 
%  information to the specified file.
%
%============================ piktul_calibrate ===========================

%
%  Name:		piktul_calibrate.m
%
...
%
%============================ piktul_calibrate ===========================
function piktul_calibrate(parms)
...
jointLabels = {'Lift','Shoulder','Elbow','Wrist','Gripper'};
minStrings  = {'2','90','-90','-90','1.125'};
zeroStrings = {'1','0','0','0','0.5'};
maxStrings  = {'0.5','-90','90','90','0.125'};
...
if (nargin > 0)
  ...
  for ii = 1:length(fnames)
    switch fnames{ii}
      ...
      case 'alphaLims',
        for jj = 1:5
          if ( isfield(parms,'alphaOrient') && (parms.alphaOrient(jj) == -1) )
            parms.alphaLims([1 3],jj) = parms.alphaLims([3 1],jj);
          end
        ...
        %minStrings{5} = num2str(parms.alphaLims(1,5));
        %zeroStrings{5} = num2str(parms.alphaLims(2,5));
        %maxStrings{5} = num2str(parms.alphaLims(3,5));
    end
  end
end
...
hfile   = uicontrol(fh,'Style','edit','String','pikparms.mat',...
